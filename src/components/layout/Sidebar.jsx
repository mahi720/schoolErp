...
const menuItems = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Payroll / Salary", href: "/hrm/payroll" },
      { label: "Events", href: "/hrm/events" },
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Students", href: "/library/students" },
      { label: "Employees", href: "/library/employees" },
      ...
      { label: "Racks", href: "/library/racks" },
...

  {
    ...
    submenu: [
      ...
      { label: "Vehicles", href: "/transportation/vehicles" },
      {
        ...
        href: "/transportation/pickup-drop-points",
      },
      { label: "Routes", href: "/transportation/routes" },
      { label: "Drivers/Helper", href: "/transportation/drivers" },
...

  {
    ...
    submenu: [
      ...
      { label: "Sub-Categories", href: "/inventory/sub-categories" },
      { label: "Brand", href: "/inventory/brand" },
      {
        ...
        submenu: [
          ...
          { label: "Damaged Items", href: "/inventory/products/damaged-items" },
          {
            ...
            href: "/inventory/products/product-issue-logs",
          },
        ],
      },
